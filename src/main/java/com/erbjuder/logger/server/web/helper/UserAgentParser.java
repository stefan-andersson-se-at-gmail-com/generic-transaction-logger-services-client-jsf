...
public class UserAgentParser {
    ...
    private final List<UserAgentDetail> parsedBrowsers = new ArrayList<UserAgentDetail>();
    ...
    public UserAgentParser(String userAgentString) {
        ...
        while (matcher.find()) {
            ...
            parsedBrowsers.add(new UserAgentDetail(nextBrowserName,
    ...
    private String[] extractBrowserNameAndVersion() {
        ...
        for (UserAgentDetail nextBrowser : parsedBrowsers) {
        ...
        UserAgentDetail firstAgent = parsedBrowsers.get(0);
